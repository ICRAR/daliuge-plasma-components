...
original_name="daliuge_plasma_components"
original_urlname="daliuge-plasma-components"
original_description="Awesome daliuge_plasma_components created by ICRAR"
...
mv daliuge_plasma_components $name
