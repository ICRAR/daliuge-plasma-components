"""
daliuge_plasma_components component module.

This is the module of daliuge_plasma_components containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/daliuge_plasma_components.MyData/String/readonly/
