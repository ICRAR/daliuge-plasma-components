...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=daliuge_plasma_components -l --tb=short --maxfail=1 tests/
...
release:          ## Create a new tag for release.
	...
	@echo "v$${TAG}" > daliuge_plasma_components/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add daliuge_plasma_components/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "daliuge_plasma_components = 'daliuge_plasma_components.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run daliuge_plasma_components'"
